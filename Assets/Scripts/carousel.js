...
class Carousel {
  constructor(el) {
    ...
    this.carouselData = [
      {
        'id': '1',
        'link': 'https://hhargrwestmec.github.io/todo_list.github.io/' ,
        'title': 'To-Do List'
      },
      {
        'id': '2',
        'link': 'https://hhargrwestmec.github.io/note_taking_app.github.io',
        'title': 'Note Taking App'
      },
      {
        'id': '3',
        'link': 'https://hhargrwestmec.github.io/movieGallery.github.io/' ,
        'title': 'Movie Gallery'
      },
      {
        'id': '4',
        'link': 'https://hhargrwestmec.github.io/planet_temps.github.io/' ,
        'title': 'Planet Weather'
      },
      {
        'id': '5',
        'link': 'https://hhargrwestmec.github.io/quiz.github.io/' ,
        'title': 'Array Quiz'
      },
      {
        'id': '6',
        'link': 'https://hhargrwestmec.github.io/array.map.github.io/' ,
        'title': 'Array.map'
      },
      {
        'id': '7',
        'link': 'https://hhargrwestmec.github.io/array.filter.github.io/' ,
        'title': 'Array.filter'
      },
      {
        'id': '8',
        'link': 'https://hhargrwestmec.github.io/dictionary.github.io/' ,
        'title': 'Dictionary'
      },
      {
        'id': '9',
        'link': 'https://hhargrwestmec.github.io/JQuery.github.io/' ,
        'title': 'JQuery Examples'
      },
      {
        'id': '10',
        'link': 'https://hhargrwestmec.github.io/javascriptQuizApp.github.io/' ,
  ...
  setupCarousel() {
    ...
    this.carouselData.forEach((item, index) => {
      ...
      // CUSTOM JS
      carouselItem.innerHTML = `<h1 class="item-title">${item.title}</h1>`;
      carouselItem.addEventListener('click', () => {window.open(item.link)})
  ...
  play() {
    ...
    if (playBtn.classList.contains('playing')) {
      ...
      // Use play state prop to store interval ID and run next method on a 3.5 second interval
